...
for(i in 1:10){
    ...
    pred <-  lm( pm2.5 ~ PC1^2 + PC2^2 + PC3 + PC4 + cbwd, data=trainData)
    y <- lm( pm2.5 ~ PC1^2 + PC2^2 + PC3 + PC4 + cbwd, data=testData)
...
fit.lm1 <- lm( pm2.5 ~ PC1^2 + PC2^2 + PC3 + PC4 + cbwd,  data=dataPCA)
summary(fit.lm1)

# For pm2.5 ~ PC1^2 + PC2^2 + PC3 + PC4 + cbwd
# MSE = 1.7974
# p-value < 2.2e-16 
# Adj R^2 = 0.09654
...
for(i in 1:10){
    ...
    pred <-  lm( pm2.5 ~ PC1^3 + PC2^2 + PC3 + PC4 + cbwd, data=trainData)
    y <- lm( pm2.5 ~ PC1^3 + PC2^2 + PC3 + PC4 + cbwd, data=testData)
...
fit.lm2 <- lm( pm2.5 ~ PC1^3 + PC2^2 + PC3 + PC4 + cbwd,  data=dataPCA)
summary(fit.lm2)
# For pm2.5 ~ PC1^2 + PC2^2 + PC3 + PC4 + cbwd
# MSE = 1.7974
# p-value < 2.2e-16 
...
for(i in 1:10){
    ...
    pred <-  lm( pm2.5 ~ PC1^3 + PC2^2 + PC3^2 + PC4 + cbwd, data=trainData)
    y <- lm( pm2.5 ~ PC1^3 + PC2^2 + PC3^2 + PC4 + cbwd, data=testData)
...
fit.lm2 <- lm( pm2.5 ~ PC1^3 + PC2^2 + PC3^2 + PC4 + cbwd,  data=dataPCA)
summary(fit.lm2)
# For pm2.5 ~ PC1^2 + PC2^2 + PC3 + PC4 + cbwd
# MSE = 1.7974
# p-value < 2.2e-16 
